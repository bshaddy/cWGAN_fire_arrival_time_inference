Contained within this repository are the data and scripts needed for performing inferrence of fire arrival times from VIIRS AF satellite measurements utilizing a cWGAN.
...
Folder results_analysis contains the codes and data pertaining to the evaluation of the performance of the cWGAN method and comparisons made to the SVM method and to the group-truth IR fire perimeter measurements. The code for producing results figures is also included. 
